            ...
            {expanded && searchTerm.trim() !== "" && (
                ...
                >
                    {filteredResults.length > 0 ? (
                        <>
                            <div style={{ fontWeight: 500, marginBottom: 4, alignItems: "center" }}>
                                Results for: <span style={{ color: "#1976d2" }}>{searchTerm}</span>
                            </div>
                        ...
                        <div style={{ fontWeight: 400, marginBottom: 4, alignItems: "center" }}>
                            No results found for: <span style={{ color: "#d32f2f" }}>{searchTerm}</span>
                        </div>
                    )}
                </div>
            )}
