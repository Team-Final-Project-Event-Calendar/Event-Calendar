    ...
    <Container className="aboutpage-primary-container" maxW="7xl" py={10} border={"1px solid"}  borderColor="blue.300" p={"20px"} mt={"40px"} borderRadius={"20px"} bg="#fbfefb">
      ...
      <Box mb={8}>
        ...
        <Text fontSize="md" lineHeight="1.7">
          Imera Calendarium is a comprehensive event management platform designed to help you organize your schedule,
          create and manage events, and connect with others. Whether you're planning personal activities, work meetings,
          or public events, our platform provides the tools you need to stay organized and connected.
        </Text>
      </Box>
        ...
        <Flex direction="column" gap={4}>
          ...
          <Box className="aboutpage-boxes-keyfeutures" p={4} shadow="md" borderWidth="1px" borderRadius="md" bg="purple.50">
            ...
            <Flex gap={2} flexWrap="wrap">
              <span style={{ background: "#EBF8FF", color: "#3182CE", padding: "2px 8px", borderRadius: "4px", margin: "2px" }}>Monthly</span>
              <span style={{ background: "#E6FFFA", color: "#319795", padding: "2px 8px", borderRadius: "4px", margin: "2px" }}>Weekly</span>
              <span style={{ background: "#F3E8FF", color: "#805AD5", padding: "2px 8px", borderRadius: "4px", margin: "2px" }}>Work Week</span>
              <span style={{ background: "#FFFAF0", color: "#DD6B20", padding: "2px 8px", borderRadius: "4px", margin: "2px" }}>Daily</span>
            </Flex>
          </Box>
